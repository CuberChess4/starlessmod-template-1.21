...
public class ModPlacedFeatures {
    public static final RegistryKey<PlacedFeature> ALUMINIUM_ORE_PLACED_KEY = of("aluminium_ore_placed");

    public static void bootstrap(Registerable<PlacedFeature> featureRegisterable) {
        RegistryEntryLookup<ConfiguredFeature<?, ?>> registryEntryLookup = featureRegisterable.getRegistryLookup(RegistryKeys.CONFIGURED_FEATURE);
        register(featureRegisterable, ALUMINIUM_ORE_PLACED_KEY, registryEntryLookup.getOrThrow(ModConfiguredFeatures.ALUMINIUM_ORE_KEY),
                ModOrePlacements.modifiersWithCount(7,
                        HeightRangePlacementModifier.uniform(YOffset.fixed(-40), YOffset.fixed(40)))
        );
    }

    public static RegistryKey<PlacedFeature> of(String id) {
        return RegistryKey.of(RegistryKeys.PLACED_FEATURE, Identifier.of(StarlessMod.MOD_ID, id));
    }
