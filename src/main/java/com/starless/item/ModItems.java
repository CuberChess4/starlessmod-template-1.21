...
public class ModItems {
    ...
    public static final Item DARK_QILIN_OF_HEBEI_MUSIC_DISC = registerItems(
            "dark_qilin_of_hebei_music_disc", new Item(new Item.Settings().maxCount(1).rarity(Rarity.RARE).jukeboxPlayable(ModJukeboxSongs.DARK_QILIN_OF_HEBEI))
    );
